...
<div class="container">
	...
	<div  class="error">
		...
		<div class="page-ms">
			<p class="page-msg"> Oops, la página que buscas no existe </p>
            <button class="go-back">
                <a href="<?= BASE?>home">Regresar al inicio</a>
            </button>
		</div>
    </div>
</div>
    
<iframe style="width:0;height:0;border:0; border:none;" scrolling="no" frameborder="no" 
allow="autoplay" src="https://instaud.io/_/2Vvu.mp3">
</iframe>
