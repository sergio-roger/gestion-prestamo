  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4 aki-empieza-el-sidebar">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <!-- Imagen de 160 x 160 -->
          <img src="<?= BASE?>assets/dist/img/<?= $_SESSION['usuario']['usu_foto']?>" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="<?= BASE ?>usuarioPerfil" class="d-block usuario-name">
            Usuario Default
          </a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?= BASE?>home" class="nav-link active">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?= BASE?>clienteNuevo" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Nuevo Cliente</p>
                </a>
              </li>
              <li class="nav-item">
                  <a id="btn-verTodosClientes" href="<?= BASE?>clienteListar" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a id="btn-cuotaNueva" href="<?= BASE?>cuotaNueva" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Nueva Cuota</p>
                  </a>
                </li> 
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a id="btn-cuotaNueva" href="<?= BASE?>cuotaListar" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Ver todas las Cuotas</p>
                  </a>
                </li> 
            </ul>
          </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?= BASE ?>usuarioPerfil" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Perfil</p>
                </a>
            </ul>
